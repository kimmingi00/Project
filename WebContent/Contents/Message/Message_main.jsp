...
<div style="border:5px solid black;"></div>
	...
	<table class="mt">
	<p style="margin-left:73%;margin-top:20px;font-size:14px;">
	<a href="javascript:delet(document.msg_fm.select)"><input type="button" name="del" value="삭제" class="btn"></a>&nbsp; 현재 총 ${fn:length(mlist)}개의 메세지가 있습니다</p>
