...
<div class="notice">
     ...
     <form method="post" name="board" enctype="multipart/form-data" action="BoardServlet?command=board_qna_write_pro&page=${page}">
	  <table border="0">
       ...
       <tr>
         ...
         <td>
         <input type="text" size="60" name="id" style="text-align:center;width:500px;" value="${user.id}" readonly></td>
       </tr>
