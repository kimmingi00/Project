     ...
     <tr>
      ...
      <font size="2">
       ...
       <c:if test="${ user.admin==1 }">
		   ...
		   <!-- 수정하기 -->
	       <a href="BoardServlet?command=board_notice_modify&idx=${board.idx}&page=${page}">
       ...
       <a href="BoardServlet?command=board_notice&page=${page}"><img src="/Contents/img/board_img/qlist.png" style="width:64px;height:64px"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>  
...
<script>
   function board_del(){
      url = "BoardServlet?command=board_notice_delete&idx=${board.idx}&page=${page}";
