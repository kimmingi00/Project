...
public class BoardQnaListAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "BoardServlet?command=board_qna";
		...
		List<QnaBoardVO> list2 = null;
		if(!s_query.equals("")) {
			list = dao.boardList(s_query, pagestart, endpage);

		} else {
			
			list = dao.boardTest(pagestart,endpage);
		}
		...
		RequestDispatcher dispatcher =request.getRequestDispatcher("/Contents/Board/Q&A/board_qna.jsp");
